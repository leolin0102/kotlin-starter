...
5. 在src文件夹下单击鼠标右键打开菜单，New &gt; Kotlin File/Class 创建 app.kt 文件。
...
可以从 Android 开发者网站下载支持 Kotlin 开发的 Android Studio 3 版本，目前还是预览版本，但是已经很稳定了。遗憾的是在国内，Android 开发网站需要VPN才可以访问，国内也有很多中文镜像网站，可以供我们下载。
